        ...
        <div className="container">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex items-center gap-8">
              ...
              <Link href="/privacy" className="font-bold uppercase tracking-wider text-sm hover:underline decoration-2 underline-offset-4 no-underline hover:bg-transparent">
                Privacy
              </Link>
              <Link href="/terms" className="font-bold uppercase tracking-wider text-sm hover:underline decoration-2 underline-offset-4 no-underline hover:bg-transparent">
                Terms
              </Link>
            </div>
          </div>
